...
package io.netty.handler.codec.http.websocketx.perftest.client;
...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    logger.info("\n==> http1 built-in codec websocket test client\n");
            ...
            .handler(
                new ChannelInitializer<SocketChannel>() {
                  ...
                  protected void initChannel(SocketChannel ch) {
                    ...
                    String path = (isEncrypted ? "wss://" : "ws://") + host + ":" + port + "/echo";
                    ...
                    pipeline.addLast(
                        http1Codec, http1Aggregator, webSocketProtocolHandler, webSocketHandler);
                  }
                })
  ...
  static class WebSocketClientHandler extends ChannelInboundHandlerAdapter {
    private final FrameCounters frameCounters;
    ...
    class FrameWriter {
      ...
      WebSocketFrame webSocketFrame(ChannelHandlerContext ctx) {
        ...
        ByteBuf payload = ctx.alloc().buffer(Long.BYTES + dataSize);
        payload
            .writeLong(index % 50_000 == 0 ? System.nanoTime() : -1)
            .writeBytes(data, 0, dataSize);
